...
CREATE TABLE `customationinfo`  (
  ...
  `consume_count` int(11) NOT NULL COMMENT '消费数量\r\n',
...
CREATE TABLE `customeramount`  (
  `customer_id` int(11) NOT NULL COMMENT '会员编号',
...
INSERT INTO `customeramount` VALUES (14, 258.00);
...
-- ----------------------------
INSERT INTO `productcountinfo` VALUES (16, 11);
...
CREATE TABLE `productininfo`  (
  `productin_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '入库信息编号',
...
CREATE TABLE `productoutinfo`  (
  `productout_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '商品出库编号',
...
-- ----------------------------
INSERT INTO `productsinfo` VALUES (16, '小老板', '', 11.00, '小老板', 1);
...
CREATE TABLE `rechargeinfo`  (
  `recharge_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '充值账单编号',
...
CREATE TABLE `reserveinfo`  (
  `reserve_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '预约编号',
  `reserve_customer_id` int(11) NOT NULL COMMENT '预约的客户编号\r\n',
...
INSERT INTO `userinfo` VALUES ('666', '666', '2020-04-09 15:04:00', 1, 1, '666', '666');
